...
var ve = (n) => {
  ...
  }, [t.closeButton, et]), Tt = React$2.useMemo(() => t.duration || X || Wt, [t.duration, X]), gt = React$2.useRef(0), U2 = React$2.useRef(0), St = React$2.useRef(0), K = React$2.useRef(null), [Gt, Qt] = st.split("-"), Rt = React$2.useMemo(() => S.reduce((r, m, c) => c >= dt ? r : r + m.height, 0), [S, dt]), Et = Ft(), qt = t.invert || e, ht = N === "loading";
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto text-center", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "p",
          {
            ...
            children: "The pond is filling up fast. Jump in before you miss the leap!"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-6", children: SOCIALS.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "a",
          {
            href: s.url,
            target: "_blank",
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(s.icon, { size: 28, style: { color: s.color } })
                }
              ),
...
const CA$2 = "G4QRtYNRPyxdKwcAqqW3xSeEynDDxEyRvrDT9FJEpump";
...
function Footer() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { style: { background: "oklch(0.18 0.06 155)" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-3 gap-10 mb-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center sm:items-start gap-3", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-2", children: [
        ...
        FOOTER_LINKS.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center sm:items-end gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "h4",
          {
            className: "font-heading text-base mb-2",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
            {
              ...
              "data-ocid": "footer.link",
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(SiTelegram, { size: 20, color: "white" })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
            {
              ...
              "data-ocid": "footer.link",
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(SiX, { size: 18, color: "oklch(0.14 0 0)" })
            }
          )
        ] })
      ] })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs", style: { color: "oklch(0.45 0.04 155)" }, children: "FORG is a meme coin with no intrinsic value or expectation of financial return. This is not financial advice." }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs", style: { color: "oklch(0.40 0.03 155)" }, children: [
            "© ",
            year,
...
const CA$1 = "G4QRtYNRPyxdKwcAqqW3xSeEynDDxEyRvrDT9FJEpump";
const BUY_LINK$3 = "https://raydium.io/swap/?inputCurrency=sol&outputCurrency=G4QRtYNRPyxdKwcAqqW3xSeEynDDxEyRvrDT9FJEpump";
const PAIR = "55kcmUzV47QDZdLh2SV3dPkRSyGzianRFYvEXgJdBWh6";
function HeroSection() {
  var _a2, _b2;
  const [dex, setDex] = reactExports.useState(null);
  const [loading, setLoading] = reactExports.useState(true);
  const intervalRef = reactExports.useRef(null);
  const fetchPrice = reactExports.useCallback(async () => {
    var _a3;
    try {
      ...
      const pair = (json == null ? void 0 : json.pair) ?? ((_a3 = json == null ? void 0 : json.pairs) == null ? void 0 : _a3[0]);
      if (pair) setDex(pair);
    } catch {
    } finally {
      setLoading(false);
  ...
  reactExports.useEffect(() => {
    fetchPrice();
    intervalRef.current = setInterval(fetchPrice, 3e4);
    return () => {
      if (intervalRef.current) clearInterval(intervalRef.current);
    };
  }, [fetchPrice]);
  const copyCA = () => {
    navigator.clipboard.writeText(CA$1);
    ue.success("Contract address copied! 🐸");
  };
  const scrollToPFP = () => {
    var _a3;
    return (_a3 = document.getElementById("pfp-generator")) == null ? void 0 : _a3.scrollIntoView({ behavior: "smooth" });
  };
  const priceChange = ((_a2 = dex == null ? void 0 : dex.priceChange) == null ? void 0 : _a2.h24) ?? 0;
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 z-0 overflow-hidden", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              style: {
                backgroundImage: "url('/assets/uploads/pond_background-019d20ee-8290-7618-8e7d-e8a75bdcc187-2.png')",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              style: {
                background: "radial-gradient(ellipse at center, rgba(0,0,0,0.18) 0%, rgba(0,0,0,0.02) 70%, transparent 100%)"
              }
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-10 flex-1 flex items-center max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-32", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-8 items-center w-full", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "p",
              {
                ...
                children: [
                  "The Pond's Most Degenerate Frog.",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "oklch(0.27 0.07 155)" }, children: "Ribbit or Regret. 🐸" })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-3 justify-center md:justify-start mb-6", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "a",
                {
                  href: BUY_LINK$3,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 py-3 flex flex-wrap items-center justify-center gap-4 sm:gap-8", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-heading text-lg", style: { color: "white" }, children: loading ? "..." : (dex == null ? void 0 : dex.priceUsd) ? `$${Number.parseFloat(dex.priceUsd).toFixed(8)}` : "N/A" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
                    ...
                    style: {
                      color: isPositive ? "oklch(0.76 0.18 130)" : "oklch(0.60 0.20 30)"
                    },
                    children: loading ? "..." : `${isPositive ? "+" : ""}${priceChange.toFixed(2)}%`
                  }
                )
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-heading text-lg", style: { color: "white" }, children: loading ? "..." : ((_b2 = dex == null ? void 0 : dex.volume) == null ? void 0 : _b2.h24) ? `$${(dex.volume.h24 / 1e3).toFixed(1)}K` : "N/A" })
              ] })
            ] })
          }
        )
...
const BUY_LINK$2 = "https://raydium.io/swap/?inputCurrency=sol&outputCurrency=G4QRtYNRPyxdKwcAqqW3xSeEynDDxEyRvrDT9FJEpump";
const STEPS = [
  {
    id: "step-wallet",
    num: "01",
...
function HowToBuy() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      className: "py-20 px-4",
      style: {
        background: "linear-gradient(180deg, oklch(0.97 0.02 155) 0%, oklch(0.93 0.05 195) 100%)"
      },
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "h2",
            {
              ...
              style: { color: "oklch(0.27 0.07 155)" },
              children: "JOIN THE POND IN 3 HOPS 🐸"
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-6", children: STEPS.map((step) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
...
function HypeTicker() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      style: { background: "oklch(0.20 0.07 155)" },
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex animate-marquee whitespace-nowrap", children: TICKER_ITEMS.map(({ key, msg }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "span",
        {
          ...
          children: [
            msg,
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "oklch(0.76 0.18 130)" }, children: "•" })
          ]
        },
        key
      )) })
...
function LiveChart() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      style: {
        background: "linear-gradient(180deg, oklch(0.93 0.05 195) 0%, oklch(0.97 0.02 155) 100%)"
      },
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto", children: [
...
const BUY_LINK$1 = "https://raydium.io/swap/?inputCurrency=sol&outputCurrency=G4QRtYNRPyxdKwcAqqW3xSeEynDDxEyRvrDT9FJEpump";
const NAV_ITEMS = [
  { label: "HOME", id: "hero" },
    ...
    "nav",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between h-16", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden md:flex items-center gap-6", children: NAV_ITEMS.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block w-6 h-0.5 bg-current mb-1" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block w-6 h-0.5 bg-current mb-1" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block w-6 h-0.5 bg-current" })
                ]
              }
            )
          ] })
...
const FROG_SRC = "/assets/uploads/refined_forg_mascot-019d21f7-2b04-74d7-97f1-2647e44a1e49-1.png";
const CHAIN_SRC = "/assets/uploads/gold_chain-019d21aa-b6ef-777d-bfc7-3a154e915328-1.png";
const BACKGROUNDS = [
  {
    id: "pond",
    label: "Pond",
...
function PFPGenerator() {
  ...
  const [selectedBg, setSelectedBg] = reactExports.useState("pond");
  const [chainOn, setChainOn] = reactExports.useState(false);
  ...
  reactExports.useEffect(() => {
    ...
    if (bg) {
      ...
      if ((bgImg == null ? void 0 : bgImg.complete) && bgImg.naturalWidth > 0) {
    ...
    if ((frogImg == null ? void 0 : frogImg.complete) && frogImg.naturalWidth > 0) {
    ...
    if (chainOn) {
      ...
      if ((chainImg == null ? void 0 : chainImg.complete) && chainImg.naturalWidth > 0) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "pfp-generator", className: "relative py-16 px-4 overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "video",
      {
        autoPlay: true,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-10", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "p",
          {
            ...
            children: "Pick a background, download your PFP, and join the FORG army!"
          }
        )
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col md:flex-row gap-8 items-start justify-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-3", children: BACKGROUNDS.map((bg) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  type: "button",
                  ...
                  style: {
                    background: selectedBg === bg.id ? "oklch(0.76 0.18 130)" : "rgba(255,255,255,0.12)",
                    color: selectedBg === bg.id ? "oklch(0.14 0 0)" : "white",
                    border: `2px solid ${selectedBg === bg.id ? "oklch(0.90 0.18 125)" : "transparent"}`,
                    transform: selectedBg === bg.id ? "scale(1.04)" : "scale(1)"
                  },
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "img",
                      {
                        ...
                        style: {
                          borderColor: selectedBg === bg.id ? "oklch(0.14 0 0)" : "transparent"
                        }
                      }
                    ),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  className: "flex items-center gap-3 rounded-2xl px-4 py-3 transition-all font-bold text-sm",
                  style: {
                    background: chainOn ? "oklch(0.76 0.18 130)" : "rgba(255,255,255,0.12)",
                    color: chainOn ? "oklch(0.14 0 0)" : "white",
                    border: `2px solid ${chainOn ? "oklch(0.90 0.18 125)" : "transparent"}`,
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "⛓️ Gold Chain" }),
                    chainOn && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-auto text-base", "aria-label": "active", children: "✓" })
                  ]
                }
              ) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col items-center overflow-auto", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: "rounded-3xl overflow-hidden shadow-forg border-4",
          ...
          !imagesLoaded && /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              className: "mt-3 text-sm font-bold animate-pulse",
              style: { color: "oklch(0.90 0.18 125)" },
              children: "🐸 Loading frog assets..."
            }
          )
        ] })
      ] })
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      style: {
        ...
        transitionDelay: `${index2 * 120}ms`
      },
      "data-ocid": `roadmap.item.${index2 + 1}`,
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: "rounded-3xl p-6 h-full shadow-forg relative overflow-hidden",
          style: {
            background: isDone ? "linear-gradient(135deg, oklch(0.85 0.12 130), oklch(0.72 0.16 130))" : isActive ? "linear-gradient(135deg, oklch(0.90 0.18 125 / 0.2), white)" : "white",
            border: `3px solid ${isDone ? "oklch(0.60 0.16 130)" : isActive ? "oklch(0.76 0.18 130)" : "oklch(0.85 0.05 155)"}`,
            boxShadow: isDone ? "0 0 30px 4px oklch(0.76 0.18 130 / 0.45)" : void 0
          },
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -top-3 -right-3 text-5xl opacity-10 pointer-events-none", children: "🪷" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3 mb-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-3xl", children: phase.emoji }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
                    ...
                    style: {
                      background: isDone ? "oklch(0.27 0.07 155)" : "oklch(0.93 0.05 155)",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2", children: phase.items.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "li",
              {
                ...
                style: {
                  color: item.done ? "oklch(0.27 0.07 155)" : "oklch(0.55 0.03 155)"
                },
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
                      ...
                      style: {
                        background: item.done ? "oklch(0.27 0.07 155)" : "oklch(0.90 0.03 155)",
                        color: item.done ? "white" : "oklch(0.60 0.04 155)"
                      },
                      children: item.done ? "✓" : "○"
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: item.done ? "font-bold" : "", children: item.text })
                ]
              },
              item.text
            )) }),
...
function Roadmap() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      style: {
        background: "linear-gradient(180deg, oklch(0.87 0.07 195) 0%, oklch(0.78 0.10 190) 100%)"
      },
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-10 left-6 text-7xl opacity-10 pointer-events-none select-none", children: "🪷" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-10 right-8 text-7xl opacity-10 pointer-events-none select-none", children: "🐸" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                ...
                children: "The journey from tadpole to ecosystem legend"
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden md:flex items-center justify-center mb-6", children: PHASES.map((phase, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
            ...
            i < PHASES.length - 1 && /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                style: {
                  background: "repeating-linear-gradient(90deg, oklch(0.76 0.18 130) 0, oklch(0.76 0.18 130) 6px, transparent 6px, transparent 12px)"
                }
              }
            )
          ] }, phase.num)) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6", children: PHASES.map((phase, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(PhaseCard, { phase, index: i }, phase.num)) })
        ] })
      ]
    }
  );
}
const BUY_LINK = "https://raydium.io/swap/?inputCurrency=sol&outputCurrency=G4QRtYNRPyxdKwcAqqW3xSeEynDDxEyRvrDT9FJEpump";
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen font-body", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(LiveChart, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(PFPGenerator, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(HypeTicker, {}),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(StickyBuyButton, {})
  ] });
}
...
Service({
  "getMemeCoin": Func([], [MemeCoin], ["query"])
});
